...
| MW-G4 | `e2e::portfolio_next_ordering`, `e2e::portfolio_ready_total_order` | done |
...
| MW-S1 | `tables::views_registered`, `conformance::views_golden` | done |
| MW-S2 | `conformance::views_golden` (a bless from the six tables + `clock` alone) | done |
...
| MW-S9 | `lint::handoff_cites_closed`, `lint::seq_collision`, `lint::views_findings` | done |
| MW-S10 | `e2e::set_handoff_mints_log_line`, `e2e::show_lineage_line` | done |
...
| MW-L1 | `e2e::add_set_frontmatter_flags`, `e2e::set_docs_replace`, `e2e::cli_surface_frozen` | done |
...
| MW-T1 | `parse::covers_key`, `tables::covers_projection` | done |
| MW-T2 | `format::clause_ref_survives_heading_edit` | done |
| MW-T3 | `e2e::cover_pins_hash`, `lint::covers_hand_written` | done |
| MW-T4 | `lint::spec_drift` | planned |
| MW-T6 | `lint::spec_drift_unversioned_corpus` | planned |
