...
- 2026-08-10T04:51Z [claude (session_016iEafFdzwyKAtsU3AEMhaU)] Owner ruling 2026-08-10 (in-session): surface UNFROZEN for this change — set gains --cat/--verify/--title. Actionable now; the DESIGN §6 table amendment and the cli_surface_frozen test update land in the same commit as the code, citing this ruling.
