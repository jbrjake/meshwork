...
- 2026-08-07T00:23Z blocked→done — verify exit 0
...
- 2026-08-07T00:23Z [claude] Shipped without a re-fire in the end: GitHub flushed the original throttled tag-push webhook as Actions recovered (run 31129945276, success 23:08 UTC). My tag re-push spawned a doomed duplicate run (cancelled) and drafted the release — re-published with gh release edit --draft=false. Verified: 2 assets, downloaded binary reports 0.1.4.
