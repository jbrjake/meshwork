...
- 2026-08-09T23:35Z [claude (session_016iEafFdzwyKAtsU3AEMhaU)] Field evidence (sazed, 2026-08-09, session 2436461e): --doc rejected again — two adds chained in one command, both failed, retried whole. Compounding detail: the agent's habitual '| tail -3' cut clap's 'unexpected argument' line, so the visible output was bare usage with no tip at all. Agents truncate output routinely; whatever the error must teach has to survive truncation from either end.
- 2026-08-10T14:40Z [claude (session_016iEafFdzwyKAtsU3AEMhaU)] Alias half REVERTED same session: the 2026-08-10 ruling comment on mw-rz4ey2h explicitly excluded --category/--doc aliases ('still awaits its own nod') — 9eccb56 shipped them under a misread of the task's 'rides the set-fields ruling' line. Did-you-mean stays (sanctioned as error-text). mw-42ygb52 is the proposal awaiting the nod; its body has the one-commit re-land path.
