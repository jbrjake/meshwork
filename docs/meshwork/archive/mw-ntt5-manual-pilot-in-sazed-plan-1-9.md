...
status: done
category: plan/m1
verify: grep -q '| 1.9 ✓' docs/PLAN-meshwork-build.md
seq: 10
docs:
  - docs/REQUIREMENTS-meshwork.md#§-4-acceptance-gate-for-v1   # clauses 1+5
  - docs/DESIGN-meshwork.md#§-7-session-integration
  - docs/DESIGN-meshwork.md#§-10-migration   # MW-J3
created: 2026-08-05
