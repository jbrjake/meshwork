...
/// The verb that lists every ask, in and out, uncapped — what a digest
/// points at when it cannot spend the bytes to list them itself (MW-M2).
pub const LIST_VERB: &str = "meshwork asks";
