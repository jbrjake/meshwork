...
// The line grammars (status spellings, log entries, comment identity,
// fence tracking) live in `grammar` (mw-0y66mhb); re-exported here
// because they are part of the parsing contract — only the file moved.
pub use crate::grammar::{
    fence_run, fenced_lines, parse_log_line, Comment, Fence, LogEntry, Status,
};
